...
{
    public class RingBurstDust : ModDust
    {
        ...
        public override bool PreDraw(Dust dust)
        {
            ...
            Main.spriteBatch.Draw(Texture2D.Value, position, Texture2D.Value.Frame(1, 1, 0, 0), dust.color, dust.rotation, new Vector2(16f,16f), scale, SpriteEffects.None, 0f);
