...
{
    public class TintableOpaqueDustLighted : ModDust
    {
        ...
        public override bool Update(Dust dust)
        {
            ...
            Lighting.AddLight(dust.position, dust.color.R * light / 256, dust.color.G * light / 256, dust.color.B * light / 256);
        ...
        public override bool PreDraw(Dust dust)
        {
            ...
            Main.spriteBatch.Draw(Texture2D.Value, position, dust.frame, dust.color, dust.rotation, new Vector2(4f,4f), scale, SpriteEffects.None, 0f);
