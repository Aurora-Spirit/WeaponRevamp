...
{
    public class MeowmereSlashProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Main.rand.NextFloat() * 2f < Projectile.Opacity)
            {
                ...
                Color dustColor = Color.Lerp(Color.White, Color.Pink, Main.rand.NextFloat() * 0.3f);
            ...
            if (Main.rand.NextFloat() * 1.5f < Projectile.Opacity)
            {
                ...
                Dust.NewDustPerfect(dustPosition, DustID.TintableDustLighted, dustVelocity, 100, new Color(Main.DiscoR, Main.DiscoG, Main.DiscoB) * Projectile.Opacity, 2f * Projectile.Opacity);
            }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color backDarkColor = new Color(35, 155, 255); // Original Excalibur color: Color(180, 160, 60)
            Color middleMediumColor = new Color(255, 78, 200); // Original Excalibur color: Color(255, 255, 80)
            ...
            // Back part
            Main.EntitySpriteDraw(texture, position, sourceRectangle, backDarkColor /** lightingColor*/ * lerpTime * 0.8f, Projectile.rotation + Projectile.ai[0] * MathHelper.PiOver4 * -1f * (1f - percentageOfLife), origin, scale, spriteEffects, 0f);
            ...
            // Middle part
            Main.EntitySpriteDraw(texture, position, sourceRectangle, middleMediumColor /** lightingColor*/ * lerpTime * 0.9f, Projectile.rotation, origin, scale, spriteEffects, 0f);
            // Front part
            Main.EntitySpriteDraw(texture, position, sourceRectangle, frontLightColor /** lightingColor*/ * lerpTime * 0.7f, Projectile.rotation, origin, scale * 0.975f, spriteEffects, 0f);
            // Thin top line (final frame)
            Main.EntitySpriteDraw(texture, position, texture.Frame(1, 4, 0, 3), new Color(Main.DiscoR, Main.DiscoG, Main.DiscoB) * 0.6f * lerpTime, Projectile.rotation + Projectile.ai[0] * 0.01f, origin, scale, spriteEffects, 0f);
            // Thin middle line (final frame)
            Main.EntitySpriteDraw(texture, position, texture.Frame(1, 4, 0, 3), new Color(Main.DiscoB, Main.DiscoR, Main.DiscoG) * 0.5f * lerpTime, Projectile.rotation + Projectile.ai[0] * -0.05f, origin, scale * 0.8f, spriteEffects, 0f);
            // Thin bottom line (final frame)
            Main.EntitySpriteDraw(texture, position, texture.Frame(1, 4, 0, 3), new Color(Main.DiscoG, Main.DiscoB, Main.DiscoR) * 0.4f * lerpTime, Projectile.rotation + Projectile.ai[0] * -0.1f, origin, scale * 0.6f, spriteEffects, 0f);
            ...
            for (float i = 0f; i < 8f; i += 1f)
            {
                ...
                DrawPrettyStarSparkle(Projectile.Opacity, SpriteEffects.None, drawpos, new Color(Main.DiscoR, Main.DiscoG, Main.DiscoB, 0) * lerpTime * (i / 9f), middleMediumColor, percentageOfLife, 0f, 0.5f, 0.5f, 1f, edgeRotation, new Vector2(0f, Utils.Remap(percentageOfLife, 0f, 1f, 3f, 0f)) * scale, Vector2.One * scale);
            }
            ...
            DrawPrettyStarSparkle(Projectile.Opacity, SpriteEffects.None, drawpos2, new Color(Main.DiscoR, Main.DiscoG, Main.DiscoB, 0) * lerpTime * 1f, middleMediumColor, percentageOfLife, 0f, 0.5f, 0.5f, 1f, 0f, new Vector2(2f, Utils.Remap(percentageOfLife, 0f, 1f, 6f, 2f)) * scale, Vector2.One * scale);
