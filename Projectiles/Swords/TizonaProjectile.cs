    ...
    public class TizonaProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Main.rand.NextFloat() * 2f < Projectile.Opacity)
            {
                ...
                Color dustColor = Color.Lerp(Color.Orange, Color.Red, Main.rand.NextFloat() * 0.3f);
            ...
            if (Main.rand.NextFloat() * 1.5f < Projectile.Opacity)
            {
                ...
                Dust.NewDustPerfect(dustPosition, DustID.TintableDustLighted, dustVelocity, 100, new Color(162, 81, 255) * Projectile.Opacity, 2f * Projectile.Opacity);
            }
        ...
        /*public override void OnHitPVP(Player target, Player.HurtInfo info)
        {
            for (int i = 0; i < 2; i++)
            {
                ParticleOrchestrator.RequestParticleSpawn(clientOnly: false, ParticleOrchestraType.NightsEdge,
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color backDarkColor = new Color(255, 54, 0); // Original Excalibur color: Color(180, 160, 60)
            Color middleMediumColor = new Color(162, 81, 255); // Original Excalibur color: Color(255, 255, 80)
            Color frontLightColor = new Color(163, 184, 255); // Original Excalibur color: Color(255, 240, 150)
            ...
            DrawPrettyStarSparkle(Projectile.Opacity, SpriteEffects.None, drawpos2, new Color(255, 255, 255, 0) * lerpTime * 1f, middleMediumColor, percentageOfLife, 0f, 0.5f, 0.5f, 1f, 0f, new Vector2(2f, Utils.Remap(percentageOfLife, 0f, 1f, 6f, 2f)) * scale, Vector2.One * scale);
