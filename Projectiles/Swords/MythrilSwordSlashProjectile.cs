...
{
    public class MythrilSwordSlashProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Main.rand.NextFloat() * 2f < Projectile.Opacity)
            {
                ...
                Color dustColor = Color.Lerp(Color.White, Color.Azure, Main.rand.NextFloat() * 0.3f);
            ...
            if (Main.rand.NextFloat() * 1.5f < Projectile.Opacity)
            {
                ...
                Dust.NewDustPerfect(dustPosition, DustID.TintableDustLighted, dustVelocity, 100, Color.LightBlue * Projectile.Opacity, 2f * Projectile.Opacity);
            }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color backDarkColor = new Color(20, 60, 180); // Original Excalibur color: Color(180, 160, 60)
            Color middleMediumColor = new Color(40, 100, 255); // Original Excalibur color: Color(255, 255, 80)
            Color frontLightColor = new Color(120, 180, 255); // Original Excalibur color: Color(255, 240, 150)
            ...
            for (float i = 0f; i < 8f; i += 1f)
            {
                ...
                DrawPrettyStarSparkle(Projectile.Opacity, SpriteEffects.None, drawpos, Color.White * lerpTime * (i / 9f), middleMediumColor, percentageOfLife, 0f, 0.5f, 0.5f, 1f, edgeRotation, new Vector2(0f, Utils.Remap(percentageOfLife, 0f, 1f, 3f, 0f)) * scale, Vector2.One * scale);
            }
            ...
            DrawPrettyStarSparkle(Projectile.Opacity, SpriteEffects.None, drawpos2, Color.White * lerpTime * 1f, middleMediumColor, percentageOfLife, 0f, 0.5f, 0.5f, 1f, 0f, new Vector2(2f, Utils.Remap(percentageOfLife, 0f, 1f, 6f, 2f)) * scale, Vector2.One * scale);
