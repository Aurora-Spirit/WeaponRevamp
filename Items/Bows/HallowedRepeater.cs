...
namespace WeaponRevamp.Items.Bows
{
    public class HallowedRepeater : GlobalItem
    {
        ...
        {
            UnifiedArrowProjectile.NewUnifiedArrow(source, position, velocity, ModContent.ProjectileType<HallowedRepeaterProjectile>(), damage, knockback, type, player.whoAmI);
            return false;
        }
