...
{
    public class CandyCorn : GlobalItem
    {
        public override bool AppliesToEntity(Item entity, bool lateInstantiation)
        {
            return entity.type == ItemID.CandyCorn;
        }
        public override void SetStaticDefaults()
        {
            ...
            Main.RegisterItemAnimation(ItemID.CandyCorn, new DrawAnimationVertical(int.MaxValue, 3));
            ...
            ItemID.Sets.FoodParticleColors[ItemID.CandyCorn] = new Color[3] {
                new Color(233, 233, 233),
                new Color(95, 239, 201),
                new Color(27, 154, 151)
            };

            ItemID.Sets.IsFood[ItemID.CandyCorn] = true; //This allows it to be placed on a plate and held correctly
        }
        ...
        public override void SetDefaults(Item item)
        {
            ...
            item.DefaultToFood(22, 22, BuffID.WellFed3, 3600); // 57600 is 16 minutes: 16 * 60 * 60 < Match for reference is minutes>seconds>ticks
